      ...
      <el-aside width="100%" style="background-color: rgb(238, 241, 246)">
        <el-main>
          <el-table
            ...
            <el-table-column align="center" prop="绑定账单" sortable label="操作" width="120">
              <template slot-scope="scope">
...
<script>
  import { getCheckRecharge } from '../../config/ajax'
  import { mapMutations, mapGetters,mapState } from 'vuex'
  export default {
    data() {
      return {
        msg:'RechargeCheckPanel',
        loading:true,
    ...
    methods:{
      ...
      async getList() {
        let { data } = await getCheckRecharge(this.params);
        this.list = data.root;
