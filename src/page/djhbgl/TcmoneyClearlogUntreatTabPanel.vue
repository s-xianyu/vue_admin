      ...
      <el-aside width="100%" style="background-color: rgb(238, 241, 246)">
        <el-main>
          <el-table
            ...
            <el-table-column align="center" prop="" label="图片" width="120">
            ...
            <el-table-column align="center" prop="" label="图片" width="100">
              <template slot-scope="scope"  @click="shClick(scope.row)">
                <!--<router-link class="ygcount" tag="span" to="/">审核</router-link>-->
                <el-button size="mini" type="primary">上传图片</el-button>
              </template>
            </el-table-column>
            <el-table-column align="center" prop="" label="放弃" width="100">
              <template slot-scope="scope">
                <!--<router-link class="ygcount" tag="span" to="/">审核</router-link>-->
                <el-button size="mini" type="primary">放弃</el-button>
              </template>
            </el-table-column>
            <el-table-column align="center" prop="real_name" sortable label="客服经理" width="120"></el-table-column>
          </el-table>
        </el-main>
      </el-aside>
    </el-container>
...
<script>
  import { getOneMonthUntreat } from '../../config/ajax'
  import { mapMutations, mapGetters,mapState } from 'vuex'
  export default {
    data() {
      return {
        msg: 'TcmoneyClearlogHb100GridPanel',
        loading:true,
        list:[],
        multipleSelection:[],
        userLogin:'',
    ...
    methods:{
      ...
      async getList (){
        let { data } = await getOneMonthUntreat(this.params);
        this.list = data.root;
        this.list.map(key=>{
