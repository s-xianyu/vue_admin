      ...
      <el-aside width="100%" style="background-color: rgb(238, 241, 246)">
        <el-main>
          <el-table
            ...
            <el-table-column align="center" prop="managerid" sortable label="客户经理" width="120"></el-table-column>
          </el-table>
        </el-main>
      </el-aside>
    </el-container>
...
<script>
  import { getClearMoney100List } from '../../config/ajax'
  ...
  export default {
    ...
    methods:{
      ...
      async getList (){
        let { data } = await getClearMoney100List(this.params);
        this.list = data.root;
        this.list.map(key=>{
