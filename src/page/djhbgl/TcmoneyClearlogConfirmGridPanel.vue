      ...
      <el-aside width="100%" style="background-color: rgb(238, 241, 246)">
        <el-main>
          <el-table
            ...
            <el-table-column align="center" prop="" sortable label="操作" width="100">
              <template slot-scope="scope">
                <!--<router-link class="ygcount" tag="span" to="/">审核</router-link>-->
                <el-button size="mini" type="primary" @click="shClick(scope.row)">修改图片</el-button>
              </template>
            </el-table-column>
            <el-table-column align="center" prop="" sortable label="操作" width="100">
              <template slot-scope="scope">
                <!--<router-link class="ygcount" tag="span" to="/">审核</router-link>-->
                <el-button size="mini" type="primary" @click="shClick(scope.row)">确认</el-button>
              </template>
            </el-table-column>
            <el-table-column align="center" prop="" sortable label="操作" width="100">
              <template slot-scope="scope">
                <!--<router-link class="ygcount" tag="span" to="/">审核</router-link>-->
                <el-button size="mini" type="primary" @click="shClick(scope.row)">解冻</el-button>
              </template>
            </el-table-column>
            <el-table-column align="center" prop="" sortable label="操作" width="100">
              <template slot-scope="scope">
                <!--<router-link class="ygcount" tag="span" to="/">审核</router-link>-->
                <el-button size="mini" type="primary" @click="shClick(scope.row)">延期</el-button>
              </template>
            </el-table-column>
            ...
            <el-table-column align="center" prop="tc_money" sortable label="赠送华币数" width="150"></el-table-column>
            <el-table-column align="center" prop="create_time" sortable label="清零时间" width="170"></el-table-column>
            <el-table-column align="center" prop="available_time" sortable label="赠送到期时间" width="170"></el-table-column>
            <el-table-column align="center" prop="modify_time" sortable label="解冻华币时间" width="170"></el-table-column>
            ...
            <el-table-column  align="center" prop="" sortable label="删除" width="120">
              <template slot-scope="scope">
                <el-button size="mini" @click="deteleImg">删除图片</el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-main>
...
<script>
  import { getTcmoneyConfimList } from '../../config/ajax'
  import { mapMutations, mapGetters,mapState } from 'vuex'
  export default {
    data() {
      return {
        msg: 'TcmoneyClearlogConfirmGridPanel.vue',
        loading:true,
        list:[],
        multipleSelection:[],
        userLogin:'',
    ...
    methods:{
      ...
      async getList (){
        let { data } = await getTcmoneyConfimList(this.params);
        this.list = data.root;
        this.list.map(key=>{
          ...
          key.modify_time = this.$forTime('YYYY-MM-DD HH:mm:ss',key.modify_time);
